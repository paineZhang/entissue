...
const (
	// Label holds the string label denoting the orgunitposition type in the database.
	Label = "org_unit_position"
	...
	// Table holds the table name of the orgunitposition in the database.
	Table = "org_unit_positions"
	// CreateByTable is the table that holds the create_by relation/edge.
	CreateByTable = "org_unit_positions"
	...
	UpdateByTable = "org_unit_positions"
	...
	BelongToOrgUnitMembersColumn = "org_unit_position_id"
	// BelongToOrgUnitTable is the table that holds the belongToOrgUnit relation/edge.
	BelongToOrgUnitTable = "org_unit_positions"
...
// Columns holds all SQL columns for orgunitposition fields.
var Columns = []string{
	FieldID,
	FieldCreateByUser,
	FieldUpdateByUser,
