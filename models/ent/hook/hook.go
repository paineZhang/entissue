...
// function as JobHistory mutator.
type JobHistoryFunc func(context.Context, *ent.JobHistoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f JobHistoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.JobHistoryMutation)
	if !ok {
...
// The OrgUnitMemberFunc type is an adapter to allow the use of ordinary
// function as OrgUnitMember mutator.
type OrgUnitMemberFunc func(context.Context, *ent.OrgUnitMemberMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrgUnitMemberFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.OrgUnitMemberMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrgUnitMemberMutation", m)
	}
	return f(ctx, mv)
}

// The OrgUnitPositionFunc type is an adapter to allow the use of ordinary
// function as OrgUnitPosition mutator.
type OrgUnitPositionFunc func(context.Context, *ent.OrgUnitPositionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrgUnitPositionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.OrgUnitPositionMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrgUnitPositionMutation", m)
	}
	return f(ctx, mv)
}
