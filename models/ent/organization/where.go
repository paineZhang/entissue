...
func CreateByUser(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdateByUser(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreateByUserEQ(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreateByUser), v))
	})
}
...
func CreateByUserNEQ(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreateByUserIn(vs ...int) predicate.Organization {
...
func CreateByUserNotIn(vs ...int) predicate.Organization {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateByUserIsNil() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreateByUserNotNil() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdateByUserEQ(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdateByUser), v))
	})
}
...
func UpdateByUserNEQ(v int) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdateByUserIn(vs ...int) predicate.Organization {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateByUserNotIn(vs ...int) predicate.Organization {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateByUserIsNil() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdateByUserNotNil() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasCreateBy() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasCreateByWith(preds ...predicate.User) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdateBy() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdateByWith(preds ...predicate.User) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUnits() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(UnitsTable, FieldID),
...
func HasUnitsWith(preds ...predicate.OrgUnit) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasStaffsWith(preds ...predicate.User) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
